...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Jul 2020 pada 00.00
...
INSERT INTO `orders_products` (`orders_products_id`, `fk_product`, `fk_pemesanan`, `jumlah_pesan_produk`, `harga_produk_pemesanan`, `nama_produk_pemesanan`, `stok_sisa`, `stok_awal`, `nama_supplier_order`, `tanggal_selesai`) VALUES
(73, 15, 54, 3, 70000, 'Payung Anak', 75, 78, 'Rahma Purnama', '21/07/2020'),
(74, 16, 54, 3, 80000, 'Payung Golf', 64, 67, 'Rahma Purnama', '21/07/2020'),
(75, 17, 54, 2, 50000, 'Payung Lipat', 55, 57, 'Rahma Purnama', '21/07/2020'),
(76, 15, 55, 4, 70000, 'Payung Anak', 71, 75, 'Rahma Purnama', '21/07/2020'),
(77, 16, 55, 2, 80000, 'Payung Golf', 62, 64, 'Rahma Purnama', '21/07/2020'),
(78, 19, 55, 3, 80000, 'Payung Pantai', 36, 39, 'Rahma Purnama', '21/07/2020'),
(79, 21, 55, 5, 80000, 'Payung Motif', 25, 30, 'Rahma Purnama', '21/07/2020');
...
(15, 44, 70000, 'Payung Anak', '1595067744_e22c69c12c06d9d654bc.jpeg', '   Payung untuk anak - anak', 71),
(16, 44, 80000, 'Payung Golf', '1595067844_64f722f8c69be4590e85.jpg', '  Payung yang biasa digunakan ketika bermain golf', 62),
...
--
ALTER TABLE `orders_products`
  MODIFY `orders_products_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
